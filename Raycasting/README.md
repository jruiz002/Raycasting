...
Este proyecto implementa un raycaster 3D sencillo usando Raylib, organizado en módulos y renderizado a un framebuffer (FBO) antes de presentarlo en pantalla.
